const status = () => {
    return ['Trabajo muy duro, como un esclavo... :musical_note:'].randomElement();
}
const advice = () => {
...
const benefit = () => {
    ...
    'Permisos para celebrar y compartir en la :energon: Conf'].randomElement();
 }
